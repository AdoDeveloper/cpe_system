...
exports.renderCreateForm = (req, res) => {
    res.render('pages/clientes/agregar', { action: 'new', cliente: {}, errors: [], title: 'Clientes' });
};
...
exports.renderEditForm = async (req, res) => {
    try {
        ...
        res.render('pages/clientes/modificar', { action: 'edit', cliente, errors: [], title: 'Clientes' });
    } catch (error) {
